...
public class StudantConexao implements Container {
	...
	public void handle(Request request, Response response) {
		try {
			...
			else if (path.startsWith("/addCoins") && "POST".equals(method)) {
				mensagem = stdService.addCoin(request);
				this.enviaResposta(Status.OK, response, mensagem);
			}
			...
			else if (path.startsWith("/addNotaAluno") && "POST".equals(method)) {
				mensagem = stdService.addNotaAluno(request);
				this.enviaResposta(Status.OK, response, mensagem);
			}
			...
			else if (path.startsWith("/getAulasSemMonitor") && "POST".equals(method)) {
				mensagem = stdService.getAulasSemMonitor(request);
				this.enviaResposta(Status.OK, response, mensagem);
			}
